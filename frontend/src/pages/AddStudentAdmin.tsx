...
export function AddStudentAdmin() {
    ...
    const submit = async (e: { preventDefault: () => void }) => {
        ...
        const response = await fetch('https://student-dashboard-cfg7.onrender.com/api/auth/add', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    return (
        <div>
            ...
            >
                {/* <Navbar /> */}
                <Card className="w-[430px] mr-auto ml-auto mt-11 mb-0 ">
                    <CardHeader>
