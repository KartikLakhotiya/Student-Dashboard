        ...
        <div>
            ...
            <nav className="bg-white border-gray-200 dark:bg-gray-900">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <a href="#" className="flex items-center space-x-3 rtl:space-x-reverse hover:text-blue-500">
                        {/* <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" className="h-6 w-6 
                        hover:text-blue-500"><rect width="256" height="256" fill="none"></rect><line x1="208" y1="128" x2="128" y2="208" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></line><line x1="192" y1="40" x2="40" y2="192" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></line></svg> */}
                        <AvatarDemo />
                        <p className="self-center text-2xl font-semibold whitespace-nowrap  ">ShadCN UI</p>
                    </a>
                    ...
                    <div className="hidden w-full md:block md:w-auto ml-auto mr-96" id="navbar-default">
                        <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                            <li>
                                <a href="#" className="block py-2 px-3 text-white rounded md:bg-transparent md:text-black md:p-0 dark:text-white md:dark:hover:text-blue-500" >Home</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="#" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">
                                    <AlertDialog>
                                        ...
                                        <AlertDialogContent>
                                            <AlertDialogHeader>
                                                <AlertDialogTitle>Contact Me At</AlertDialogTitle>
                                                <AlertDialogDescription>
                                                    +91 123 456 789
                                                </AlertDialogDescription>
                                            </AlertDialogHeader>
